...
> Use a configuration function if you need access to `webpack.LoaderOptionsPlugin` for custom configuration while Webpack loaders are in the process of migrating to Webpack 2.
...
- [Webpack Configuration](#webpack-configuration)
  ...
  - [`webpack.postcss`](#postcss-arrayplugin) - custom PostCSS plugins
